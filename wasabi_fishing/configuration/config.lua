...
Config.fishingRod = {
	{ itemName = 'fishingrod', model = 'prop_fishing_rod_01', breakChance = 25 },	-- Item name of fishing rod, --Chance of breaking pole when failing skillbar (Setting to 0 means never break)
	{ itemName = 'jewelfishingrod', model = 'jewelfishingrod', breakChance = 0 },
}
